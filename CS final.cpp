...
int buy_ticket1(){
	...
	//	showingtoday();	
		...
		int tickets, choice1;
		cout<<"\n\t\t\t\t Enter number of ticket you would like to purchase (20 limit): ";
		cin>>tickets;
		if( tickets==0 ){
			int ch;
			cout<< "\n\t\t\t\t You decided on 0 tickets. Press 1 to go back to main menu and 0 to exit program.";
			cin>>ch;
			if (ch==1){
			main();	
			}
