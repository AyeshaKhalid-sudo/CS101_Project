...
void randomaddsdeal();
void randomaddsdeal(){
string randomaddsdeal[]{"\tComing Soon!SThe Unbreakable Boy!","\tSnack Combo-Large Popcorn&Drink for just $10!","\tJoin VIP! Earn points, get rewards!","\tFree birthday ticket. Celebrate with us!","\tMatinee specials. Discounted tickets all day!",
"\tSpecial Screening!One-night-only IMAX screening!","\tPrepare for scares.THE CONJURING– Only in theaters!","\tFun for all ages!Kung Fu Panda 4 is now showing!","\tStory of love&loss.The Shawshank Redemption–in theaters now!","\tThe future is here.INCEPTION!","Watch your favorite movies in comfort!",
